...
├── slash command handlers: /codex, /codex-ping, /codex-list, /codex-select
...
- Workspace aliases resolve to host-local paths before session start and still pass canonical allowed-workspace validation.
